...
<form class="search-form">
	...
	<div class="search-option">
		<div>
			<input name="type" type="radio" value="type-users" id="type-users"> <label for="type-users"> <svg class="edit-pen-title">
		...
		<div>
			<input name="type" type="radio" value="type-posts" id="type-posts"> <label for="type-posts"> <svg class="edit-pen-title">
...
<div class="search_content">
	<table>
		<tr>
			<td><img id="profileImg" src="resources/img/common/basic_profile.png" alt="기본프로필사진"> <span id="writer">friends_one</span> <span id="content">안녕하세요 첫번째 목록입니다.</span> <a href="#"><i class="fas fa-user-plus"></i></a></td>
			<td><img id="profileImg" src="resources/img/common/basic_profile.png" alt="기본프로필사진"> <span id="writer">friends_two</span> <span id="content">안녕하세요 두번째 목록입니다.</span> <a href="#"><i class="fas fa-user-plus"></i></a></td>
		</tr>
	</table>
</div>